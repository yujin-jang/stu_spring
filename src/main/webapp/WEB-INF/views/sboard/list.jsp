		...
		<div class="col-md-12">
			...
			<div class="box">
				...
				<div class="box-body">
					...
					<button id="searchBtn" class="btn btn-sm btn-info">Search</button>
					<button id="newBtn" class="btn btn-sm btn-warning">New Board</button>
				</div>
	...
	<div class="text-center">
		<ul class="pagination">
			...
			<c:if test="${(pageMaker.next) && (pageMaker.endPage>0)}">
				<li><a href="list${pageMaker.makeSearch(pageMaker.endPage+1)}">
				&raquo;</a></li>
			</c:if>
		</ul>
	</div>
